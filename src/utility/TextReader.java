...
public class TextReader extends FilterReader {
    ...
    public static class FormatError extends TextReader.Error {
    ...
    public static class EOFError extends TextReader.Error {

        private static final long serialVersionUID = 7526472295622776888L;
    ...
    private void doError(String message) {
        ...
        if (throwExceptionOnError) {
            throw new TextReader.Error(message);
        }
    }
    ...
    private void doFormatError(String message) {
        ...
        errorMessage = message;
        if (throwExceptionOnError) {
            throw new TextReader.FormatError(message);
        }
    }
